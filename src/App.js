...
import { ReactComponent as Post } from './posticon.svg';
    ...
    <div className="conteudo">
      <div className={`direita ${style}`} >
        ...
        <div className={`brand-navlist`}>
          ...
          {/* Nav List */}
          <button className={`nav-icons selecionado`} onKeyDown={e => cliqueDiv(e, 1)}>
            <Home width={40} height={40} />
            <div className={`nav-text selecionado`}>
              Dashboard
            </div>
          </button>

          <button className={`nav-icons`} onKeyDown={e => cliqueDiv(e, 2)}>
            <Post width={40} height={40} />
